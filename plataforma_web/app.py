...
from .v1.materias_tipos_juicios.paths import (
    materias_tipos_juicios as materias_tipos_juicios_v1,
)
from .v1.materias_tipos_juzgados.paths import (
    materias_tipos_juzgados as materias_tipos_juzgados_v1,
)
...
from .v2.materias_tipos_juicios.paths import (
    materias_tipos_juicios as materias_tipos_juicios_v2,
)
from .v2.materias_tipos_juzgados.paths import (
    materias_tipos_juzgados as materias_tipos_juzgados_v2,
)
...
from .v1.listas_de_acuerdos_acuerdos.paths import (
    listas_de_acuerdos_acuerdos as listas_de_acuerdos_acuerdos_v1,
)
from .v2.listas_de_acuerdos_acuerdos.paths import (
    listas_de_acuerdos_acuerdos as listas_de_acuerdos_acuerdos_v2,
)
...
from .v1.repsvm_delitos_especificos.paths import (
    repsvm_delitos_especificos as repsvm_delitos_especificos_v1,
)
from .v2.repsvm_delitos_especificos.paths import (
    repsvm_delitos_especificos as repsvm_delitos_especificos_v2,
)
from .v1.repsvm_delitos_genericos.paths import (
    repsvm_delitos_genericos as repsvm_delitos_genericos_v1,
)
from .v2.repsvm_delitos_genericos.paths import (
    repsvm_delitos_genericos as repsvm_delitos_genericos_v2,
)
from .v1.repsvm_tipos_sentencias.paths import (
    repsvm_tipos_sentencias as repsvm_tipos_sentencias_v1,
)
from .v2.repsvm_tipos_sentencias.paths import (
    repsvm_tipos_sentencias as repsvm_tipos_sentencias_v2,
)
...
from .v1.tesis_jurisprudencias.paths import (
    tesis_jurisprudencias as tesis_jurisprudencias_v1,
)
from .v2.tesis_jurisprudencias.paths import (
    tesis_jurisprudencias as tesis_jurisprudencias_v2,
)

# Ubicaciones de Expedientes
from .v1.ubicaciones_expedientes.paths import (
    ubicaciones_expedientes as ubicaciones_expedientes_v1,
)
from .v2.ubicaciones_expedientes.paths import (
    ubicaciones_expedientes as ubicaciones_expedientes_v2,
)
...
app.include_router(
    listas_de_acuerdos_acuerdos_v1,
    prefix="/listas_de_acuerdos_acuerdos",
    tags=["listas de acuerdos"],
)
app.include_router(
    listas_de_acuerdos_acuerdos_v2,
    prefix="/v2/listas_de_acuerdos_acuerdos",
    tags=["listas de acuerdos"],
)
...
app.include_router(
    repsvm_delitos_especificos_v2,
    prefix="/v2/repsvm_delitos_especificos",
    tags=["repsvm"],
)
...
app.include_router(
    tesis_jurisprudencias_v1,
    prefix="/tesis_jurisprudencias",
    tags=["tesis y jurisprudencias"],
)
app.include_router(
    tesis_jurisprudencias_v2,
    prefix="/v2/tesis_jurisprudencias",
    tags=["tesis y jurisprudencias"],
)

# Ubicaciones de Expedientes
app.include_router(
    ubicaciones_expedientes_v1,
    prefix="/ubicaciones_expedientes",
    tags=["ubicaciones de expedientes"],
)
app.include_router(
    ubicaciones_expedientes_v2,
    prefix="/v2/ubicaciones_expedientes",
    tags=["ubicaciones de expedientes"],
)
