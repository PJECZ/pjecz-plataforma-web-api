        ...
        for tesis_jurisprudencia, autoridad, distrito in get_tesis_jurisprudencias(db, autoridad_id=autoridad_id):
            resultados.append(
                TesisJurisprudenciaOut(
                    ...
                    epoca=tesis_jurisprudencia.epoca,
                    materia_id=tesis_jurisprudencia.materia_id,
                    materia=tesis_jurisprudencia.materia,
                    ...
                    instancia=tesis_jurisprudencia.instancia,
...
async def consultar_un_tesis_jurisprudencia(tesis_jurisprudencia_id: int, db: Session = Depends(get_db)):
    ...
    return TesisJurisprudenciaOut(
        id=tesis_jurisprudencia.id,
        distrito_id=tesis_jurisprudencia.distrito_id,
        distrito=tesis_jurisprudencia.distrito.nombre,
